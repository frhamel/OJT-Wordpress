...
All images are under Creative Commons Public Domain deed CC0.
    ...
    Source 		: https://pxhere.com/en/photo/1230649

    License 	: CC0 1.0 Universal (CC0 1.0)
    License URI	: https://pxhere.com/en/license
    Source 		: https://pxhere.com/en/photo/760396
    ...
    License 	: CC0 1.0 Universal (CC0 1.0)
    License URI	: https://pxhere.com/en/license
    Source 		: https://pxhere.com/en/photo/1383612
...
== Changelog ==
    ...
    1.3.4 - August 14, 2023
    * Update: Updated fontawesome to 6.1.1 and added tiktok icon.
    * Refinements for child theme.
    
    1.3.3
    * Fixed: Header design issue in inner pages is fixed.

    1.3.2
    * Fixed : Minor bug fixes.
    
    1.3.1
    * New Feature : Compatiblity Theme styling settings added for modern and classic design.
    * New feature : Added Static CTA banner.
    * Fixed : Minor Bug fixes.
